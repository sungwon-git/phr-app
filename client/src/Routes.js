...
const routesConfig = [
	...
	},
	{
		...
		routes: [
			...
			// 	exact: true,
			// 	path: "/oauth2",
			// 	component: lazy(() => import("src/views/phr/OAuth2")),
			// },
			{
				exact: true,
				path: "/oauth2",
		...
		routes: [
			{
				exact: true,
				path: "/phr",
				component: () => <Redirect to="/phr/organizations" />,
			},
			{
				exact: true,
				path: "/phr/organizations",
				component: lazy(() => import("src/views/phr/Organization")),
			},
			{
				exact: true,
				path: "/phr/records",
				component: lazy(() => import("src/views/phr/Records")),
			},
			{
				exact: true,
				path: "/phr/records/categorization",
				component: lazy(() => import("src/views/phr/Records/DocumentCategorizationView")),
			},
			{
				exact: true,
				path: "/phr/record/:id",
				component: lazy(() => import("src/views/phr/Records/DocumentsView")),
			},
			{
				exact: true,
				path: "/phr/record/:id/preview",
				component: lazy(() => import("src/views/phr/Records/DocumentsView/Details/DocumentPreview")),
			},
			{
				exact: true,
				path: "/phr/record/:id/sourceview",
				component: lazy(() => import("src/views/phr/Records/DocumentsView/Details/DocumentSourceView")),
			},
			// {
			// 	exact: true,
			// 	path: "/phr/records/alternative",
			// 	component: lazy(() => import("src/views/phr/EncountersView")),
			// },
		],
	},
	// {
